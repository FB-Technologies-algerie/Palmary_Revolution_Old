  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg">
          <p class="text-center txtTitle">Maquette du produit</p>
          <div style="margin-top:100px">
            <div class="text-center">
      ...
      <div class="row">
        <div class="col-lg text-center">
          <a href="#imageRogne" id="validBtn" class="btn btn-primary m-3 mx-auto" onclick="getimage(this)">
            Suivant
          </a>
        </div>
      </div>
      ...
      <div id="imageRogne">
        ...
        <a id="validOcrBtn" class="btn btn-primary m-3 mx-auto d-block" onclick="ocr(this)" >
          Analyser les textes
        </a>
        <div id="verificationText" class="row">
          <div class="col">
            <div class="progress">
              <div
      ...
      <div id="resultStep">
        <p class="text-center txtTitle m-3">Les textes</p>
        <div class="row">
    ...
    <script>
      ...
      function getimage(val) {
        ...
        document.getElementById("imageRogne").style.display = "block";
      }
          ...
          .finally(result => {
            ...
            window.Tesseract2 = Tesseract.recognize(outputCropped2, "fra")
              ...
              .finally(result => {
                ...
                window.location.href="#resultStep";
                check();
              });
          });
      }
