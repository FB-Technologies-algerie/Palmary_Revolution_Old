  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg">
          <p class="text-center txtTitle">
            Echantillon d'emballage arrivé
          </p>
          <div id="cropper">
            ...
            <img id="output" src="<?= $img1 ?>" />
          </div>
        </div>
        <div class="col-lg">
          <p class="text-center txtTitle">Maquette Référence</p>
          <div style="margin-top:100px">
            <div class="text-center">
      ...
      <div class="row">
        <div class="col-lg text-center">
          <a href="#verificationCouleur" id="validBtn" class="btn btn-primary m-3 mx-auto" onclick="getimage(this)">suivant</a>
        </div>
      </div>

      <div id="verificationCouleur">
        <p class="text-center txtTitle">les deux images rognées</p>
        <div class="row">
        ...
        <div class="row">
          <div class="col">
            <div id="image-data" class="float-right" style="width: 100%">
              RGBA
              <div class="progress">
                <div class="progress-bar bg-primary blue" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
              <div class="progress">
                <div class="progress-bar bg-success green" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
              <div class="progress">
                <div class="progress-bar bg-danger red" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
              <div class="progress">
                <div class="progress-bar bg-secondary gray" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
              Noir &amp; blanc
              <div class="progress">
                <div class="progress-bar bg-light white" role="progressbar" style="width: 0%;color: black" aria-valuenow=""
                  aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div class="progress">
                <div class="progress-bar bg-dark black" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
            
              Luminosité
              <div class="progress">
                <div class="progress-bar bg-warning orange" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
            </div>
          </div>
          <div class="col">
            <div id="image-data" class="float-right" style="width: 100%">
              RGBA
              <div class="progress">
                <div class="progress-bar bg-primary blue2" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
              <div class="progress">
                <div class="progress-bar bg-success green2" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
              <div class="progress">
                <div class="progress-bar bg-danger red2" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
              <div class="progress">
                <div class="progress-bar bg-secondary gray2" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
              Noir &amp; blanc
              <div class="progress">
                <div class="progress-bar bg-light white2" role="progressbar" style="width: 0%;color: black" aria-valuenow=""
                  aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div class="progress">
                <div class="progress-bar bg-dark black2" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
            
              Luminosité
              <div class="progress">
                <div class="progress-bar bg-warning orange2" role="progressbar" style="width: 0%" aria-valuenow="" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
            </div>
          </div>
    ...
    <script>
      ...
      function getimage(val) {
        ...
        document.getElementById("verificationCouleur").style.display = "block";
        ressamble(outputCropped.src,'');
        ressamble(outputCropped2.src, 2);
